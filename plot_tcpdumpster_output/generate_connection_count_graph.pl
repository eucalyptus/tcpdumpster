...
my $scr_name = "gnuplot_script_connection_count.script";
my $data_name = "tcpdumpster.output";
my $png_name = "connection_count.png";
...
print SCR "set title \"TCP-DUMPSTER: UNIQUE CONNECTION COUNT\"\n";
...
print SCR "set ylabel \"CONN. COUNT\"\n";
#print SCR "set ytics 0, 2\n";
print SCR "set terminal png size 1200, 800\n";
print SCR "set output \"" . $png_loc ."\"\n";
print SCR "plot \"" . $data_loc . "\" using 1:7 title \"Connection Count\" with lines\n";
print SCR "exit\n";
