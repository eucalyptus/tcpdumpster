...
my $scr_name = "gnuplot_script_packet_length_total.script";
my $data_name = "tcpdumpster.output";
my $png_name = "packet_length_total.png";
...
print "\n";
print "================= PLOT PACKET LENGTH TOTAL =====================\n";
print "\n";
...
print SCR "set title \"TCP-DUMPSTER: PACKET LENGTH TOTAL\"\n";
