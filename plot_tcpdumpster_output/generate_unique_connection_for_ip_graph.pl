...
my $scr_name = "gnuplot_script_unique_connection_for_ip.script";
my $data_name = "tcpdumpster.output";
my $png_name = "unique_connection_for_ip.png";
...
print "\n";
print "================= PLOT UNIQUE CONNECTION FOR IP =====================\n";
print "\n";
...
print SCR "set title \"TCP-DUMPSTER: UNIQUE CONNECTION FOR IP\"\n";
...
print SCR "set ylabel \"UNIQUE IP COUNT\"\n";
#print SCR "set ytics 0, 2\n";
print SCR "set terminal png size 1200, 800\n";
print SCR "set output \"" . $png_loc ."\"\n";
print SCR "plot \"" . $data_loc . "\" using 1:3 title \"Source IP\" with lines,";
print SCR "\"" . $data_loc . "\" using 1:5 title \"Dest. IP\" with lines\n";
print SCR "exit\n";
